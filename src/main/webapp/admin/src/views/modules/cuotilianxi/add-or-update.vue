<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="错题编号" prop="cuotibianhao">
          <el-input v-model="ruleForm.cuotibianhao" 
              placeholder="错题编号" clearable  :readonly="ro.cuotibianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="错题编号" prop="cuotibianhao">
              <el-input v-model="ruleForm.cuotibianhao" 
                placeholder="错题编号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="练习时间" prop="lianxishijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.lianxishijian" 
                type="date"
                :readonly="ro.lianxishijian"
                placeholder="练习时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.lianxishijian" label="练习时间" prop="lianxishijian">
              <el-input v-model="ruleForm.lianxishijian" 
                placeholder="练习时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="练习结果" prop="lianxijieguo">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.lianxijieguo" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.lianxijieguo" label="练习结果" prop="lianxijieguo">
                    <span v-html="ruleForm.lianxijieguo"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.lianxishijian = this.getCurDate()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='cuotibianhao'){
            this.ruleForm.cuotibianhao = obj[o];
	    this.ro.cuotibianhao = true;
            continue;
          }
          if(o=='jiaoshigonghao'){
	    ...
	    this.ro.zuoyemingcheng = true;
          ...
          if(o=='lianxishijian'){
            this.ruleForm.lianxishijian = obj[o];
	    this.ro.lianxishijian = true;
            continue;
          }
          if(o=='lianxijieguo'){
            this.ruleForm.lianxijieguo = obj[o];
	    this.ro.lianxijieguo = true;
            continue;
          }
          if(o=='xuehao'){
	...
	this.ruleForm.lianxijieguo = this.ruleForm.lianxijieguo.replace(reg,'../../../ssmgp6yp/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `cuotilianxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.cuotilianxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
