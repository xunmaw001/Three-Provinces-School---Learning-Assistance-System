  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zuoyebianhao" label="作业编号" prop="zuoyebianhao">
              <el-input v-model="ruleForm.zuoyebianhao" 
                placeholder="作业编号" readonly></el-input>
          </el-form-item>
        </div>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.zuoyeneirong = this.ruleForm.zuoyeneirong.replace(reg,'../../../ssmgp6yp/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
