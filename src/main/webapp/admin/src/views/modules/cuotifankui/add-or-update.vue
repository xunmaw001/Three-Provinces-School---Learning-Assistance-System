  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.cuotibianhao" label="错题编号" prop="cuotibianhao">
              <el-input v-model="ruleForm.cuotibianhao" 
                placeholder="错题编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="错题类型" prop="cuotileixing">
          <el-input v-model="ruleForm.cuotileixing" 
              placeholder="错题类型" clearable  :readonly="ro.cuotileixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="错题类型" prop="cuotileixing">
              <el-input v-model="ruleForm.cuotileixing" 
                placeholder="错题类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="错题内容" prop="cuotineirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.cuotineirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.cuotineirong" label="错题内容" prop="cuotineirong">
                    <span v-html="ruleForm.cuotineirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.faburiqi = true;
          ...
          if(o=='cuotileixing'){
            this.ruleForm.cuotileixing = obj[o];
	    this.ro.cuotileixing = true;
            continue;
          }
          if(o=='cuotineirong'){
            this.ruleForm.cuotineirong = obj[o];
	    this.ro.cuotineirong = true;
            continue;
          }
          if(o=='xuehao'){
	...
	this.ruleForm.cuotineirong = this.ruleForm.cuotineirong.replace(reg,'../../../ssmgp6yp/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `cuotifankui/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.cuotifankuiCrossAddOrUpdateFlag = false;
						 this.parent.search();
