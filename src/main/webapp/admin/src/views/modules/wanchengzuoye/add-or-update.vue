<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zuoyefujian" label="作业附件" prop="zuoyefujian">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.zuoyefujian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="作业备注" prop="zuoyebeizhu">
          <el-input v-model="ruleForm.zuoyebeizhu" 
              placeholder="作业备注" clearable  :readonly="ro.zuoyebeizhu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="作业备注" prop="zuoyebeizhu">
              <el-input v-model="ruleForm.zuoyebeizhu" 
                placeholder="作业备注" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tijiaoshijian = true;
          ...
          if(o=='zuoyebeizhu'){
            this.ruleForm.zuoyebeizhu = obj[o];
	    this.ro.zuoyebeizhu = true;
            continue;
          }
          if(o=='xuehao'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `wanchengzuoye/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.wanchengzuoyeCrossAddOrUpdateFlag = false;
						 this.parent.search();
