...
public class CuotilianxiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public CuotilianxiEntity() {
		
	}
	
	public CuotilianxiEntity(T t) {
		try {
	 ...
	 * 设置：错题编号
	 */
	public void setCuotibianhao(String cuotibianhao) {
		this.cuotibianhao = cuotibianhao;
	}
	/**
	 * 获取：错题编号
	 */
	public String getCuotibianhao() {
		return cuotibianhao;
	}
	/**
	 * 设置：教师工号
