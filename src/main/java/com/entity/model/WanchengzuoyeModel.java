 ...
 */
public class WanchengzuoyeModel  implements Serializable {
	...
	public void setZuoyebeizhu(String zuoyebeizhu) {
		this.zuoyebeizhu = zuoyebeizhu;
	}
	
	/**
	 * 获取：作业备注
	 */
	public String getZuoyebeizhu() {
		return zuoyebeizhu;
	}
